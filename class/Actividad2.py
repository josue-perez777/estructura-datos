...
if __name__ == "__main__":
    persona1 = Persona("Josue", 19, "Masculino")
    persona1.presentarse()
    cuenta1 = CuentaBancaria(persona1, 5000, "1234567")
    cuenta1.depositar(500)
    print("Saldo actual:", cuenta1.consultar_saldo())
    rectangulo1 = Rectangulo(15, 5)
    ...
    cancion1 = Cancion("Imagine", "John Lennon", "Imagine", 1.1)
    cancion1.reproducir()
    producto1 = Producto("Iphone", 1500, 3)
    print("Total de compra:", producto1.calcular_total(2))
    estudiante1 = Estudiante("Juan", 15, "Español")
